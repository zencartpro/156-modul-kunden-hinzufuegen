...
define('TABLE_HEADING_ACCOUNT_CREATED', 'Kundenkonto angelegt');
define('TABLE_HEADING_LOGIN', 'Letztes Login');
define('TABLE_HEADING_ACTION', 'Aktion');
define('TABLE_HEADING_PRICING_GROUP', 'Preisgruppe');
define('TABLE_HEADING_AUTHORIZATION_APPROVAL', 'Autorisiert');
define('TEXT_DATE_ACCOUNT_CREATED', 'Account angelegt:');
define('TEXT_DATE_ACCOUNT_LAST_MODIFIED', 'zuletzt geändert:');
define('TEXT_INFO_DATE_LAST_LOGON', 'Letztes Login:');
define('TEXT_INFO_NUMBER_OF_LOGONS', 'Anzahl der Logins:');
...
define('TEXT_INFO_ORDERS_TOTAL', 'Gesamt:');
...
define('CATEGORY_EMAIL', 'Willkommensemail');
define('ENTRY_PASSWORD_CONFIRM_ERROR','Passwörter stimmen nicht überein. Bitte nochmal eingeben');
define('ENTRY_PASSWORD', 'Passwort:');
define('ENTRY_CONFIRM_PASSWORD', 'Passwortbestätigung:');
...
define('EMAIL_TEXT_3', 'Sie können ab sofort unsere umfangreichen Dienstleistungen in Anspruch nehmen, die wir für Sie bereit gestellt haben.' . "\n\n" . '
...
define('MESSAGE_CUSTOMERS_OK', 'Kunden wurden erfolgreich hinzugefügt.');
